...
class top_black(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._transition_width_range = Range(samp_rate/1000, samp_rate/2, 1000, samp_rate/8, 200)
        ...
        self._cutoff_range = Range(samp_rate/1000, samp_rate/2, 1000, samp_rate/8, 1)
        self._cutoff_win = RangeWidget(self._cutoff_range, self.set_cutoff, 'cutoff', "counter", float)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, self.cutoff, self.transition_width, firdes.WIN_HAMMING, 6.76))
...
def main(top_block_cls=top_black, options=None):
