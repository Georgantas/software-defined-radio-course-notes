...
class lesson1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.channel_freq2 = channel_freq2 = 93.5e6
        self.channel_freq = channel_freq = 92.5e6
        ...
        # Blocks
        ##################################################
        self._channel_freq2_tool_bar = Qt.QToolBar(self)
        self._channel_freq2_tool_bar.addWidget(Qt.QLabel('channel_freq2' + ": "))
        self._channel_freq2_line_edit = Qt.QLineEdit(str(self.channel_freq2))
        self._channel_freq2_tool_bar.addWidget(self._channel_freq2_line_edit)
        self._channel_freq2_line_edit.returnPressed.connect(
            lambda: self.set_channel_freq2(eng_notation.str_to_num(str(self._channel_freq2_line_edit.text()))))
        self.top_grid_layout.addWidget(self._channel_freq2_tool_bar)
        self._channel_freq_tool_bar = Qt.QToolBar(self)
        self._channel_freq_tool_bar.addWidget(Qt.QLabel('channel_freq' + ": "))
        ...
        self._audio_gain_range = Range(0, 10, 1, 0, 200)
        ...
        self.connect((self.analog_wfm_rcv_0_0, 0), (self.blocks_add_xx_0, 1))
    ...
    def set_channel_freq2(self, channel_freq2):
        ...
        Qt.QMetaObject.invokeMethod(self._channel_freq2_line_edit, "setText", Qt.Q_ARG("QString", eng_notation.num_to_str(self.channel_freq2)))
